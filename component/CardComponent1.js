...
export const CardComponent1 = (product1) =>{
    const{
        title,
        price,
        image
    }= product1;
    return ` <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700d h-[250px]">
    <a href="#">
